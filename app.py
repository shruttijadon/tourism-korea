...
if choice == "Home":
    ...
    My current academic, project, and leadership work are all aligned toward a focused goal:  
    **securing the Global Korea Scholarship (GKS) to pursue an M.Tech / M.S. in Data Science and AI at a premier South Korean university by September 2028.**
    """)
...
# --- SKILLS & LEARNING ---
    ...
    st.divider()
    st.info(
        "**Core Focus:** Integrating technical proficiency with Korea‑specific case studies so that my future graduate research "
        "proposal is not abstract, but based on concrete work I have already started."
    )
